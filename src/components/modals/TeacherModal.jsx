  ...
  return (
    <>
      <BaseModal
        ...
        description="Create teacher profiles that can be assigned to sections."
        onClose={onClose}
        maxWidth="max-w-3xl"
      >
              ...
              <div className="relative flex items-center gap-4 rounded-md border border-slate-200 bg-slate-50 p-4">
                ...
                <div className="pr-10">
                  ...
                  <p className="mt-1 text-xs text-slate-500">
                    ...
                    <span className="font-black">teacherPhoto</span> in API
                    FormData.
                  </p>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              ...
              <input
                ...
                onChange={(event) =>
                  handleChange("teacherId", event.target.value)
                }
